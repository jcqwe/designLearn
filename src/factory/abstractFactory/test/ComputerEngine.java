...
import factory.abstractFactory.CPUFactory;
import factory.abstractFactory.MainBoardApi;
import factory.abstractFactory.MainBoardFactory;
...
public class ComputerEngine {
    ...
    /**
     * 装机过程
     * @param abstractFactory 客户选择的装机方案
     */
    ...
    private void prepareHardwares(AbstractFactory abstractFactory){
        ...
        //直接找相应的工厂获取
        this.cpu = abstractFactory.createCPUApi();
        this.mainboard = abstractFactory.createMainBoardApi();
